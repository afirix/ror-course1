...
class LineAnalyzer
  ...
  def calculate_word_frequency
    ...
    #p "calculate_word_frequency #{hash}"

    @highest_wf_count = hash.values.max
    @highest_wf_words = hash.select { |key, value| value == @highest_wf_count }.keys
...
class Solution
  ...
  def print_highest_word_frequency_across_lines
    ...
    @highest_count_words_across_lines.each do |analyzer|
      puts "[#{analyzer.highest_wf_words.join(", ")}] (appears in line #{analyzer.line_number})"
    end
  end
end
